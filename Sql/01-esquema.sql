...
CREATE TABLE USUARIO(
    ...
    CONSTRAINT CK_EMAIL CHECK(EMAIL ~ '^[A-Za-z0-9._%-]+@[A-Za-z0-9.-]+[.][A-Za-z]+$'),
...
CREATE TABLE ALUNO(
    ...
    CONSTRAINT CK_EMAIL_ALUNO CHECK(EMAIL ~ '^[A-Za-z0-9._%-]+@[A-Za-z0-9.-]+[.][A-Za-z]+$')
);
